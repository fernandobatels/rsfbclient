...
macro_rules! mk_tests_default {
    ( $( $tests:tt )* ) => {
        mk_tests! {
            ...
            #[cfg(all(feature = "linking", not(feature = "embedded")))]
            ...
            #[cfg(all(feature = "linking", feature = "embedded"))]
            ...
            #[cfg(all(feature = "dynamic_loading", not(feature = "embedded")))]
            ...
            #[cfg(all(feature = "dynamic_loading", feature = "embedded"))]
